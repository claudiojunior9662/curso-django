...
class Announcemment(models.Model):
...
class Comment(models.Model):
    announcemment = models.ForeignKey(Announcemment, verbose_name="Anúncio", related_name="comments", on_delete=models.CASCADE)
    user = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name="Usuário", related_name="comments", on_delete=models.CASCADE)
